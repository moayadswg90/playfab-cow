handlers.glickoTest = function (args, context) 
{
	...
	var rating = (Math.abs(p1.getRating() - 1464) < 0.1).should.be.true;
	var rd = (Math.abs(p1.getRd() - 151.52) < 0.01).should.be.true;
	var vol = (Math.abs(p1.getVol() - 0.05999) < 0.00001).should.be.true;
